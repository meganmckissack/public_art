...
##SUMMARY:
The locations of public art in Portland, Oregon, are avail on the [Civic Apps](http://www.civicapps.org/datasets/public-art). Sadly, the data do not appear to be updated regularly. Nevertheless this could be a valuable public resource. 

To get the data use the following function. The data are read direcntly from my github repo.
...
The train.column.types simplifies the data cleaning for analysis.
